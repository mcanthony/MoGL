                        ...
                        while (i2--) {
                            ...
                            if(temp){
                                ...
                                for (j = 0; j < len; j++) {
                                    ...
                                    mergeData.position[t0] = temp.x,
                                    mergeData.position[t1] = temp.y,
                                    mergeData.position[t2] = temp.z,
                                    mergeData.rotate[t0] = temp.rotateX,
                                    mergeData.rotate[t1] = temp.rotateY,
                                    mergeData.rotate[t2] = temp.rotateZ,
